...
namespace Microsoft.AspNetCore.SignalR
{
    public class JsonHubProtocol : IHubProtocol
    {
        ...
        public HubMessage ParseMessage(Stream stream, IInvocationBinder binder)
        {
        ...
        public void WriteMessage(HubMessage message, Stream stream)
        {
        ...
        {
            var invocationId = json.Value<int>(InvocationIdPropertyName);
